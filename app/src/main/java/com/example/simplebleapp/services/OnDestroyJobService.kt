package com.example.simplebleapp.services
import android.app.job.JobParameters
import android.app.job.JobService
import android.util.Log
import com.example.simplebleapp.MainActivity
...
* */
class OnDestroyJobService : JobService() {
    companion object {
        const val JOB_ID = 222
        val jobServiceLogTag = " - OnDestroyJobService"
    ...
    override fun onStartJob(params: JobParameters?): Boolean {
        mainActivity?.jobServiceOnDestroy()
